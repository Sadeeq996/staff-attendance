...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonSegment, IonSegmentButton, IonLabel, IonList, IonItem, IonNote, IonDatetime, IonButton, IonButtons, IonIcon } from '@ionic/angular/standalone';
...
@Component({
    ...
    standalone: true,
    imports: [IonIcon, IonButtons, IonHeader, IonToolbar, IonTitle, IonContent, IonSegment, IonSegmentButton, IonLabel, IonList, IonItem, IonNote, IonDatetime, CommonModule, FormsModule, IonButton]
})
